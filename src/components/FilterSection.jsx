...
const FilterSection = ({search,setSearch,brand,priceRange,setPriceRange,category,setCategory,handleBrandChange,handleCategoryChange,setBrand}) => {
  ...
  return (
    <div className='bg-gray-100 mt-10 p-4 rounded-md h-max hidden md:block'>
      ...
      <select name='' id=" "className='bg-white w-full p-2 border-gray-400 border-2 rounded-md mb-3' value={brand}
      ...
      <div className='flex-col gap-2 mt-3'>
        ...
        onClick ={()=> {setSearch(''); setCategory('ALL'); setBrand('ALL'); setPrizeRange([0,5000])}}>Reset filters</button>
    </div>
  )
}
